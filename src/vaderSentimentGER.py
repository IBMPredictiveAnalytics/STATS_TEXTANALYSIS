...
# history
# 03-01-2023 Set data file locations to be in STATS_TEXTANALYSIS subdirectory under the .py file
# 03-01-2023 Use zip file for lexicon data
...
BOOSTER_DICT = \
    {"absolut": B_INCR, "total": B_INCR, "unbedingt": B_INCR, #"absolutely": B_INCR,
     "erstaunlich": B_INCR,  #"amazingly": B_INCR,
     "enorm": B_INCR, #"awfully": B_INCR,
     "komplett": B_INCR, "restlos": B_INCR, "gänzlich": B_INCR, "völlig": B_INCR,    #"completely": B_INCR,
     "beträchtlich": B_INCR, "erheblich": B_INCR, "deutlich": B_INCR, #"considerably": B_INCR,
     "ausgesprochen": B_INCR, "eindeutig": B_INCR, #"decidedly": B_INCR,
     "zutiefst": B_INCR, #"deeply": B_INCR,
     "verdammt": B_INCR, #"effing": B_INCR,
     "überaus": B_INCR, #"enormously": B_INCR,
     #"entirely": B_INCR,
     "besonders": B_INCR, # "especially": B_INCR,
     "außerordentlich": B_INCR, "außergewöhnlich": B_INCR, "ungemein": B_INCR,  #"exceptionally": B_INCR,
     "äußerst": B_INCR, "extrem": B_INCR, #"extremely": B_INCR,
     "sagenhaft": B_INCR, #"fabulously": B_INCR,
     #"flipping": B_INCR,
     #"flippin": B_INCR,
     #"fricking": B_INCR,
     #"frickin": B_INCR,
     ...
     #"friggin": B_INCR,
     #"fully": B_INCR,
     "verfickt": B_INCR, #"fucking": B_INCR,
     "sehr": B_INCR, "massiv": B_INCR, "mega": B_INCR,   #"greatly": B_INCR,
     #"hella": B_INCR,
     "höchst": B_INCR, #"highly": B_INCR,
     "immens": B_INCR, #"hugely": B_INCR,
     #"incredibly": B_INCR,
     #"intensely": B_INCR,
     #"majorly": B_INCR,
     #"more": B_INCR,
     ...
     #"remarkably": B_INCR,
     "so": B_INCR,
     "wesentlich": B_INCR,  #"substantially": B_INCR,
     #"thoroughly": B_INCR,
     #"totally": B_INCR,
     #"tremendously": B_INCR,
     "über": B_INCR, #"uber": B_INCR,
     #"unbelievably": B_INCR,
     #"unusually": B_INCR,
     #"utterly": B_INCR,
     #"very": B_INCR,
     #####
     "fast": B_DECR, "nahezu": B_DECR, "beinahe": B_DECR, "beinah": B_DECR, #"almost": B_DECR,
     #"barely": B_DECR,
     "kaum": B_DECR, #"hardly": B_DECR,
     "geradeso": B_DECR, #"just enough": B_DECR,
     "irgendwie": B_DECR, "ziemlich": B_DECR, "quasi": B_DECR, #"kind of": B_DECR,
     #"kinda": B_DECR,
     #"kindof": B_DECR,
     #"kind-of": B_DECR,
     #"less": B_DECR,
     #"little": B_DECR,
     "geringfügig": B_DECR, "unwesentlich": B_DECR, "marginal": B_DECR, #"marginally": B_DECR,
     "zeitweise": B_DECR, "gelegentlich": B_DECR, "mitunter": B_DECR, #"occasionally": B_DECR,
     "halbwegs": B_DECR, "teils": B_DECR, "tweilweise": B_DECR, #"partly": B_DECR,
     #"scarcely": B_DECR,
     "etwas": B_DECR, "bisschen": B_DECR, #"slightly": B_DECR,
     "einigermaßen": B_DECR, #"somewhat": B_DECR,
     "derlei": B_DECR, "gewissermaßen": B_DECR, #"sort of": B_DECR,
     #"sorta": B_DECR,
     #"sortof": B_DECR,
     #"sort-of": B_DECR
     }
...
class SentimentIntensityAnalyzer(object):
    ...
    """
    # Lexicon zip file is assumed to be in the STATS_TEXTANALYSIS directory under this py file.
    # Contents are the lexicon and emoji files.
    # They are assumed to be in utf-8 encoding and to have \n line ending but they need to be decoded to strings.
    # The Zip read function only reads in b mode.
    
    def __init__(self, lexicon_file="GERVaderLexicon.txt", emoji_lexicon="emoji_utf8_lexicon.txt"):
        
        _this_module_file_path_ = os.path.abspath(getsourcefile(lambda: 0))
        #lexicon_full_filepath = os.path.join(os.path.dirname(_this_module_file_path_), "STATS_TEXTANALYSIS", lexicon_file)
        lexiconpath = os.path.join(os.path.dirname(_this_module_file_path_), "STATS_TEXTANALYSIS", "lex.ZIP")

        try:
            with zipfile.ZipFile(lexiconpath) as lexgerman:
                with lexgerman.open(lexicon_file) as lex:
                    self.lexicon_full_filepath = lex.read().decode("utf-8")
                with lexgerman.open(emoji_lexicon) as lex:
                    self.emoji_full_filepath = lex.read().decode("utf-8")
                self.lexicon = self.make_lex_dict()
                self.emojis = self.make_emoji_dict()    
        except:
            print(f"""German lexicon file {lexicon_file} could not be found or could not be read.""")
            raise 
    ...
    def sentiment_valence(self, valence, sentitext, item, i, sentiments):
        ...
        if item_lowercase not in self.lexicon:
            item_lowercase = item.lower()
                        # change
            if item_lowercase not in self.lexicon:
                item_lowercase = item.capitalize()
                # -------- Originale Fortsetzung
